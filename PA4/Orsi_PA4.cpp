...
Programming Assignments: PA4
Description: This code runs the game Craps which inturn enables gambling :(, but this code does accomplish all tasks set forward to do on PA4.
*/
#include <iostream>
#include <cstdlib>
#include <ctime>
